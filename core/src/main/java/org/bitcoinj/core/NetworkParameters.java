...
public abstract class NetworkParameters {
    ...
    public static final String ID_UNITTESTNET = "org.bitcoinj.unittest";
	 /** The string returned by getId() for the Cico mainnet. */
    public static final String ID_CICO_MAINNET = "org.bitcoinj.cico_mainnet";

    /** The string returned by getId() for the Cico mainnet. */
    public static final String ID_CICO_TESTNET = "org.bitcoinj.cico_testnet";
    ...
    public static NetworkParameters fromID(String id) {
        if (id.equals(ID_MAINNET)) {
            ...
            return RegTestParams.get();
        } else if (id.equals(ID_CICO_MAINNET)) {
            return CicoMainNetParams.get();
        } else if (id.equals(ID_CICO_TESTNET)) {
            return CicoTestNetParams.get();
